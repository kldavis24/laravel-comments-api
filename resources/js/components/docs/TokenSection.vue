    ...
    <div>
        <div class="container-fluid docs-section text-center pt-6 pb-6 tracking-wide">
            <div class="docs__center text-left">
                <h3><span class="docs__post_color">POST</span> Get OAuth Token</h3>
                <p class="docs__url_box mb-3 mt-1">{{ endpoint }}</p>
                <p class="mb-6">
                    After creating a User, hitting this route with the login credentials will generate an
                    OAuth token specifically for that User. That token will be needed for all further API access for that User.
                </p>
                    ...
                    <tr>
                        <td class="docs__text_md">
                            { <br>
                                ...
                                <span class="docs__curl_tab">"remember_me": boolean</span> <br>
                            }
                        </td>
                    </tr>
                    </tbody>
                ...
                <div v-if="visibleExample === 'cliVisible'" class="docs__curl_container">
                    <p class="docs__curl_example">
                        ...
                        -d <span class="docs__curl_string">'{<br>
                            ...
                            <span class="docs__curl_tab2">"remember_me": true,</span><br>
                        <span class="docs__curl_tab">}'</span></span>
                    </p>
                </div>
                <div v-if="visibleExample === 'phpVisible'" class="docs__curl_container">
                    <p class="docs__curl_example">
                        <span class="docs__php_method">public function <span class="docs__php_variable">getAuthToken</span><span class="docs__php_default">()<br> {</span></span><br>
                            ...
                            <span class="docs__php_variable docs__curl_tab">$endpoint</span><span class="docs__php_default"> = <span class="docs__php_string">'api/login'</span>;</span><br>
                            ...
                            <span class="docs__php_variable docs__curl_tab">$data <span class="docs__php_default"> = [ <br></span></span>
                                ...
                                <span class="docs__php_string docs__curl_tab2">'remember_me' <span class="docs__php_default"> => </span><span class="docs__php_method italic">true</span></span><br>
                ...
                <div v-if="visibleExample === 'jsVisible'" class="docs__curl_container">
                    <p class="docs__curl_example">
                        ...
                        <span class="docs__js_default"><span class="docs__js_method">getAuthToken</span>() {</span><br>
                            ...
                            <span class="docs__js_default docs__curl_tab"><span class="docs__js_variable italic">let</span><span class="docs__js_var"> endpoint</span> = <span class="docs__js_string">'api/login'</span></span><br>
...
<script>
    export default {
        ...
        mounted() {
            console.log('TokenSection component mounted!')
        },
