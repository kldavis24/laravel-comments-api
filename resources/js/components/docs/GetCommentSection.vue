    ...
    <div>
        <div class="container-fluid text-center pt-6 pb-6 tracking-wide">
            <div class="docs__center text-left">
                <h3><span class="docs__get_color">GET</span> Get Comment By ID</h3>
                <p class="docs__url_box bt-1 mb-2">{{ endpoint }}</p>
                <p class="mb-6">
                    As long as a Comment exists with the passed-in id, this will return the Comment's JSON data.
                </p>
                ...
                <div v-if="visibleExample === 'phpVisible'" class="docs__curl_container">
                    <p class="docs__curl_example">
                        <span class="docs__php_method">public function <span class="docs__php_variable">getCommentById</span><span class="docs__php_default">(</span><span class="docs__php_parameter">$id</span><span class="docs__php_default">)<br> {</span></span><br>
                            ...
                            <span class="docs__php_variable docs__curl_tab">$full_path</span><span class="docs__php_default"> = </span><span class="docs__php_variable">$url<span class="docs__php_default"> . </span><span class="docs__php_string">'/'</span><span class="docs__php_default"> . </span>$endpoint</span><span class="docs__php_default"> . <span class="docs__php_string">'/'<span class="docs__php_default"> . </span></span><span class="docs__php_parameter">$id</span></span><span class="docs__php_default">;</span><br>
                ...
                <div v-if="visibleExample === 'jsVisible'" class="docs__curl_container">
                    <p class="docs__curl_example">
                        ...
                        <span class="docs__js_default"><span class="docs__js_method">getCommentById</span>(<span class="docs__js_parameter">id</span>) {</span><br>
                            ...
                            <span class="docs__js_default docs__curl_tab"><span class="docs__js_variable italic">let</span><span class="docs__js_var"> full_path</span> = <span class="docs__js_string">`</span>${<span class="docs__js_var">url</span>}<span class="docs__js_string">/</span>${<span class="docs__js_var">endpoint</span>}<span class="docs__js_string">/</span>${<span class="docs__js_parameter">id</span>}</span><span class="docs__js_string">`</span><br>
...
<script>
    export default {
        name: "GetCommentsSection",

        mounted() {
            console.log('GetCommentsSection component mounted!')
        },
