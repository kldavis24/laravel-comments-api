    ...
    <div>
        <div class="container-fluid text-center pt-6 pb-6 tracking-wide">
            <div class="docs__center text-left">
                <h3><span class="docs__get_color">GET</span> Return A List Of Available Categories</h3>
                <p class="docs__url_box bt-1 mb-2">{{ endpoint }}</p>
                <p class="mb-6">
                    Hitting this endpoint will provide the user with the current list of category titles to be used in comment creation.
                </p>
                ...
                <div v-if="visibleExample === 'phpVisible'" class="docs__curl_container">
                    <p class="docs__curl_example">
                        <span class="docs__php_method">public function <span class="docs__php_variable">getCategoryNames</span><span class="docs__php_default">()<br> {</span></span><br>
                        ...
                        <span class="docs__php_variable docs__curl_tab">$endpoint</span><span class="docs__php_default"> = <span class="docs__php_string">'api/categories'</span>;</span><br>
                ...
                <div v-if="visibleExample === 'jsVisible'" class="docs__curl_container">
                    <p class="docs__curl_example">
                        ...
                        <span class="docs__js_default"><span class="docs__js_method">getCategoryNames</span>() {</span><br>
                        ...
                        <span class="docs__js_default docs__curl_tab"><span class="docs__js_variable italic">let</span><span class="docs__js_var"> endpoint</span> = <span class="docs__js_string">'api/categories'</span></span><br>
...
export default {
    ...
    mounted() {
        console.log('CategoriesSection component mounted!')
    },
